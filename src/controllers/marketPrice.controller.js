...
class MarketPriceController {
   ...
   */
  async createMarketPrice(req, res, next) {
    try {
   ...
   */
  async getAllMarketPrices(req, res, next) {
    try {
   ...
   */
  async getMarketPriceHistory(req, res, next) {
    try {
   ...
   */
  async getMarketPriceById(req, res, next) {
    try {
      const { id } = req.params;
   ...
   */
  async updateMarketPrice(req, res, next) {
    try {
      const { id } = req.params;
   ...
   */
  async deleteMarketPrice(req, res, next) {
    try {
      const { id } = req.params;
