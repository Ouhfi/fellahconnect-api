 ...
 */
async function createSaleOffer(req, res, next) {
  try {
 ...
 */
async function getAllSaleOffers(req, res, next) {
  try {
    const where = {};
 ...
 */
async function getSaleOfferById(req, res, next) {
  try {
    const { id } = req.params;
 ...
 * Update a sale offer
 */
async function updateSaleOffer(req, res, next) {
  try {
    const { id } = req.params;
    const { harvestId, marketId, quantity, unitPrice, offerDate, status } = req.body;
 ...
 * Delete a sale offer
 */
async function deleteSaleOffer(req, res, next) {
  try {
    const { id } = req.params;
